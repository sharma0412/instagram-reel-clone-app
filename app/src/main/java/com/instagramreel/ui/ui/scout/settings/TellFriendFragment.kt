...
import com.instagramreel.ui.ui.scout.adapter.TellFriendsAdapter
...
class TellFriendFragment : Fragment() {
    ...
    private fun readContacts() {
        Dexter.withContext(requireContext()).withPermission(Manifest.permission.READ_CONTACTS).withListener(object :
            PermissionListener {
    ...
    private fun tellFriendsRV() {
        binding.rvTellFriends.adapter = TellFriendsAdapter(this,contactList)
    }
