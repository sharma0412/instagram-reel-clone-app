...
import com.instagramreel.ui.ui.athlete.settings.AthleteTellFriendFragment


class AthleteTellFriendsAdapter(
    val context: AthleteTellFriendFragment,
    private val contactList: ArrayList<ContactModel>
) : RecyclerView.Adapter<AthleteTellFriendsAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        holder.binding.apply {
            ...
            container.setOnClickListener {
                ...
                startActivity(context.requireContext(), smsIntent, null)
            }
        }
    }
